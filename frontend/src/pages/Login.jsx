...
export default function Login() {
    ...
    return (
        <>
            <div className="w-screen h-screen flex flex-col justify-center items-center bg-gradient-to-br from-gray-100 to-gray-200 px-4">
                <div className="max-w-lg w-full flex flex-col px-5 py-8 sm:px-8 rounded-xl bg-white shadow-lg border border-gray-100">
                    ...
                    <h2 className="text-lg font-semibold tracking-tight text-center my-4">Sign in to your account</h2>
                    <div>
