...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleMethodTypeMismatchErrors(MethodArgumentTypeMismatchException e) {
    ...
    @ExceptionHandler(UserForbiddenJobException.class)
    public ResponseEntity<String> handleForbiddenJob(UserForbiddenJobException e) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
    }

    @ExceptionHandler(UserAlreadyExistsException.class)
    public ResponseEntity<String> handleUserAlreadyExistsError(UserAlreadyExistsException e) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(e.getMessage());
    }

    @ExceptionHandler(RefreshTokenExpiredException.class)
    public ResponseEntity<String> handleRefreshTokenExpiredError(RefreshTokenExpiredException e) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(e.getMessage());
    }
